---
title: "MRCIGVAR Workflow"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{MRCIGVAR Workflow}
...
```{r mrcigvar-estimation, eval = FALSE}
...
```{r mrcigvar-selection, eval = FALSE}
...
- `core-model-workflows` for the simpler single-regime families
- `irf-and-girf` for response-analysis conventions
