---
title: "Migration Guide for the Refactored API"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Migration Guide for the Refactored API}
...
This vignette explains how to move from legacy function names to the refactored
snake_case API.
...
Legacy compatibility wrappers live in:

- `R/compat-legacy-aliases.R`
...
- do not add hand-written deprecated wrappers outside the generated alias file

## Related vignettes

- `mrcigvar-introduction` for the package overview
- `core-model-workflows` for standard usage patterns
- `mrcigvar-workflow` for the flagship multi-regime workflow
